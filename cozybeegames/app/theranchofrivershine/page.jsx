      ...
      <main className="pt-[68px]">
        ...
        <div className="relative h-48 sm:h-64 overflow-hidden">
          <Image
            ...
            alt="The Ranch of Rivershine Banner"
            layout="fill"
            objectFit="cover"
            priority
          />
            ...
            >
              <div className="relative flex flex-col justify-center items-center w-full max-w-xs mx-auto sm:mx-0 -mt-24 sm:-mt-40 mb-6">
                <div className="aspect-[2/3] relative z-10 w-full border-2 border-[#5C4033] rounded-lg overflow-hidden">
                  <Image
                    src="/assets/images/Rivershine_LibraryCapsule_600x900.png"
                    alt="The Ranch of Rivershine Game Art"
                    layout="fill"
                    objectFit="cover"
                ...
                <div className="w-full text-center flex flex-col justify-center mt-4">
                  <h1 className="text-2xl font-bold text-[#5D4037] mb-2">The Ranch of Rivershine</h1>
                  <p className="text-sm text-[#6D3A25] italic">A cozy farming and ranch simulation game</p>
                </div>
              </div>

              <Card className="bg-white shadow-md w-full sm:max-w-xs">
                <CardContent className="p-6 space-y-6">
                  <FactsheetItem title="Developer" content={["Cozy Bee Games", "Montreal, Canada"]} />
                  <FactsheetItem title="Publisher" content={["Cozy Bee Games", "Montreal, Canada"]} />
                  <FactsheetItem title="Release Date" content={["Coming Soon"]} />
                  <FactsheetItem title="Platforms">
                    <SocialButton icon={<FaSteam className="mr-1 h-4 w-4" />} label="Steam" />
                  </FactsheetItem>
                  <FactsheetItem title="Price" content={["TBA"]} />
                  <FactsheetItem title="Press Contact">
                    <a href="mailto:press@cozybee.games" className="text-[#8D6E63] hover:underline">press@cozybee.games</a>
                  </FactsheetItem>
                  <FactsheetItem title="Social Media">
                    <div className="grid grid-cols-2 gap-2">
                      <SocialButton icon={<FaTwitter className="mr-1 h-4 w-4" />} label="Twitter" />
                      <SocialButton icon={<FaDiscord className="mr-1 h-4 w-4" />} label="Discord" />
                      <SocialButton icon={<FaFacebook className="mr-1 h-4 w-4" />} label="Facebook" />
                      <SocialButton icon={<FaInstagram className="mr-1 h-4 w-4" />} label="Instagram" />
                    </div>
                  </FactsheetItem>
                </CardContent>
              </Card>
            ...
            >
              <section>
                ...
                <p className="text-lg text-[#5D4037] leading-relaxed mb-4">
                  The Ranch of Rivershine is a heartwarming farming and ranch simulation game set in the picturesque Rivershine Valley. Players inherit a run-down ranch and embark on a journey to restore it to its former glory while building meaningful relationships with the local community.
                </p>
                <p className="text-lg text-[#5D4037] leading-relaxed">
                  With its charming pixel art style and soothing soundtrack, The Ranch of Rivershine offers a relaxing escape into a world brimming with warmth, wonder, and endless possibilities. Cultivate crops, raise animals, craft artisanal goods, and uncover the rich history of the valley as you create your own cozy corner of the world.
                </p>
              </section>
              ...
              <section>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <ImageWithZoom src="/placeholder.svg?height=200&width=350" alt="Screenshot 1" />
                  <ImageWithZoom src="/placeholder.svg?height=200&width=350" alt="Screenshot 2" />
                  <ImageWithZoom src="/placeholder.svg?height=200&width=350" alt="Screenshot 3" />
                  <ImageWithZoom src="/placeholder.svg?height=200&width=350" alt="Screenshot 4" />
                </div>
              </section>
            </motion.div>
          </div>
